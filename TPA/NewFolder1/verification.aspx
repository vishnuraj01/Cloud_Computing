<%@ Page Title="" Language="C#" MasterPageFile="~/Tpa/Clouds.master" AutoEventWireup="true" CodeFile="verification.aspx.cs" Inherits="Tpa_verification" %>
        ...
        <tr>
            ...
            <td>
                ...
                &nbsp;<asp:Button ID="btn_decrypt" runat="server" onclick="btn_decrypt_Click" 
                    Text="Decrypt" CssClass="myButton" EnableViewState="False" 
        ...
        <tr>
            ...
            <td>
                <asp:HyperLink ID="HyperLink1" runat="server" CssClass="title" 
                    NavigateUrl="~/Tpa/Tpacloudhome.aspx">Back</asp:HyperLink>
            </td>
            <td>
                <asp:Button ID="btn_upload" runat="server" Text="Upload" 
                    onclick="btn_upload_Click" CssClass="myButton" EnableViewState="False" 
