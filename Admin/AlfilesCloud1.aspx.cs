...
public partial class Admin_AlfilesCloud1 : System.Web.UI.Page
{
    ...
    public static string Fid_C1;
    public static ArrayList ArrLst_C1 = new ArrayList();
    public static ArrayList ArrLst_CPDP = new ArrayList();
    public static int CountC1, CountCPDP, C1;
    ...
    protected void AllFileDetails()
    {
        ...
        ArrLst_C1.Clear();
        ArrLst_CPDP.Clear();
        string SQL_FidC1 = "select fid from Filearchieve1";
        mobj.ReadData_Cloud1(SQL_FidC1);
        while (mobj.dr1.Read())
        {
            ArrLst_C1.Add(mobj.dr1.GetValue(0).ToString());
            CountC1++;
        }
        mobj.dr1.Close();
        ...
        for (int j = 0; j < CountC1; j++)
        {
            string SELECT_SQL = "select UserRegistration.ownerFName+' '+UserRegistration.ownerLName as Ownername,Filearchieve.fsubject,Filearchieve.fsizeinkb, " +
                         ...
                         " UserRegistration,Filearchieve where UserRegistration.uname=Filearchieve.fowner and Filearchieve.Fid=" + ArrLst_C1[j].ToString() + " order by Filearchieve.fid desc";
