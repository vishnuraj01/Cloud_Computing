<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="AlfilesCloud1.aspx.cs" Inherits="Admin_AlfilesCloud1" %>
        ...
        <tr>
            ...
            <td >
                ...
                runat="server" AutoGenerateColumns="False" AllowPaging="True" BackColor="White" 
                    BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="3px" CellPadding="3" 
                    CssClass="Grid" AlternatingRowStyle-CssClass="alt" PagerStyle-CssClass="pgr"
                    onpageindexchanging="GridView1_PageIndexChanging" Width="830px" 
                    PageSize="18">
                    <Columns>
