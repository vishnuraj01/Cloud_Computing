<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Alfiles.aspx.cs" Inherits="Admin_AlfilesCloud1" %>
        ...
        <tr>
            ...
            <td align="center">
                ...
                runat="server" AutoGenerateColumns="False" AllowPaging="True" BackColor="White" 
                    ...
                    onpageindexchanging="GridView1_PageIndexChanging" Width="930px" CssClass="Grid" AlternatingRowStyle-CssClass="alt" PagerStyle-CssClass="pgr" 
                    PageSize="15">
                    <Columns>
