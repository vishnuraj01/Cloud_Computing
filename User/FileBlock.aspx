    ...
    <table width="650">
        ...
        <tr>
            ...
            <td>
                File Block1</td>
            <td>
                <asp:TextBox ID="txt_block1" runat="server" CssClass="textbox" Height="100px" 
        ...
        <tr>
            ...
            <td>
                File Block2</td>
            <td>
                <asp:TextBox ID="txt_block2" runat="server" CssClass="textbox" Height="100px" 
                    TextMode="MultiLine" Width="310px"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                File Block3</td>
            <td>
                <asp:TextBox ID="txt_block3" runat="server" CssClass="textbox" Height="100px" 
                    TextMode="MultiLine" Width="310px"></asp:TextBox>
            </td>
        </tr>
        <tr>
