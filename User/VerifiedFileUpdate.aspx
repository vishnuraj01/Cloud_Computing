<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.master" AutoEventWireup="true" CodeFile="VerifiedFileUpdate.aspx.cs" Inherits="User_FileUpdate" %>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton1" runat="server" 
                                    ...
                                    Font-Size="10.5pt">DELETE</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
